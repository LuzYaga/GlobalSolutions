...
╚══════════════════════════════════════╝
      ...
      ▼              ▼              ▼
╔═══════════╗ ╔═══════════════╗ ╔═══════════╗
║ PLANTACAO ║ ║IMAGEM_SATELITE║ ║  ALERTA   ║
╠═══════════╣ ╠═══════════════╣ ╠═══════════╣
║- id       ║ ║- id           ║ ║- id       ║
║- cultura  ║ ║- dataCaptura  ║ ║- tipo     ║
║- area     ║ ║- indiceVeg.   ║ ║- nivel    ║
║- dataPlan.║ ║- umidade      ║ ║- descricao║
║- idFazenda║ ║- idFazenda    ║ ║- dataAlert║
╠═══════════╣ ╠═══════════════╣ ║- idFazenda║
║+ getters  ║ ║+ getters      ║ ╠═══════════╣
║+ setters  ║ ║+ setters      ║ ║+ getters  ║
║+ toString ║ ║+ toString     ║ ║+ setters  ║
╚═══════════╝ ╚═══════════════╝ ║+ toString ║
      │                         ╚═══════════╝
      │ 1:N
      ▼
...
O script SQL completo está localizado em `sql/script.sql` e contém:
...
└── js/
    ├── dados.js            (Dados simulados compartilhados)
