...
// SENSOR_CLIMATICO — corresponde à tabela SENSOR_CLIMATICO do SQL e à classe SensorClimatico.java
const sensores = [
...
// RELATORIO — FK corrigida: idPlantacao
// Corresponde à tabela RELATORIO do SQL e à classe RelatorioAgricola.java
const relatorios = [
    { id: 1, dataRelatorio: "05/06/2025", produtividade: 3450.0, recomendacao: "Manter manejo atual. Vegetação em estágio avançado de desenvolvimento.",             idPlantacao: 1 },
    { id: 2, dataRelatorio: "05/06/2025", produtividade: 1950.0, recomendacao: "Aumentar irrigação em 15% devido a estresse hídrico moderado detectado.",             idPlantacao: 3 },
    { id: 3, dataRelatorio: "06/06/2025", produtividade: 4500.7, recomendacao: "Inspecionar área para possível infestação. Índice de vegetação crítico.",             idPlantacao: 5 }
];
...
// Funções para manipulação local (LocalStorage para simular persistência)
function obterDados() {
